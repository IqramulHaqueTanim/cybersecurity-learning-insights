...
* `http` or `dns` (Filters by protocol name) and etc.![Packet Filtering Example](wireshark_packet-filtering.png) **Figure 1:** Filtering packets by specific source and destination IP addresses.
